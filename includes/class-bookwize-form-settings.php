        ...
        $this->settings = [
            [
                ...
                'settings' => [
                    ...
                    ['bwf_hotel_url', 'Hotel Url', 'text', 'https://presentation.bookwize.com or the slug of the internal page'],
                ]
            ],
            [
                'name' => 'themes',
                    ...
                    ['bwf_theme', 'Choose Theme', 'select', 'Default theme',
                        [
                            'options' => [
                                ...
                                'bookwize-theme-3' => 'horizontal theme 3',
            ...
            [
                ...
                'settings' => [
                    ...
                    ['bwf_load_resources', "Load tranlations from system resources", 'checkbox'],
                    ['bwf_datepicker_format', 'Datepicker format', 'select', 'Default yy-mm-dd',
                        [
                            'options' => [
                                'yy-mm-dd' => 'ISO 8601 - yy-mm-dd ex. 2020-12-31',
                                'mm/dd/y' => 'mm/dd/y - ex. 12/31/20',
                                'mm/dd/yy' => 'mm/dd/yy - ex. 12/31/2020',
                                'dd/mm/y' => 'dd/mm/y - ex. 31/12/20',
                                'dd/mm/yy' => 'dd/mm/yy - ex. 31/12/2020',
                                'd M, y' => 'd M, y - ex. 31 Dec, 20',
                                'd M, yy' => 'd M, y - ex. 31 Dec, 2020',
                                'd MM, y' => 'd MM, y - ex. 31 December 20',
                                'd MM, yy' => 'd MM, y - ex. 31 December 2020'
                            ],
                        ]
                    ],
                ]
