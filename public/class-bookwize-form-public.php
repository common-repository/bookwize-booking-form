...
class Bookwize_Form_Public
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_localize_script($this->bookwize_form . '-app', 'bwf_options', [
            'datepicker_format' => get_option('bwf_datepicker_format','yy-mm-dd'),
            'load_resources' => get_option('bwf_load_resources',false),
            'pluginVersion' => '1.9.7'
        ]);
    }
